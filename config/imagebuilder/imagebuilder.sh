...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        exfat-mkfs f2fs-tools f2fsck fdisk gawk getopt gzip hostapd-common iconv iw iwinfo jq \
        ...
        pigz ppp ppp-mod-pppoe pv rename resize2fs runc tar tini htop tune2fs \
        uclient-fetch uhttpd uhttpd-mod-ubus unzip uuidgen wget-ssl whereis \
        which wpad-basic ziptool zoneinfo-asia zoneinfo-core zstd \
        \
        luci luci-base luci-compat luci-lib-base \
        luci-lib-ip luci-lib-ipkg luci-lib-jsonc luci-lib-nixio luci-mod-admin-full luci-mod-network \
        luci-mod-status luci-mod-system luci-proto-ipip luci-proto-ipv6 luci-proto-ppp \
        \
        luci-app-amlogic \
        \
        ${config_list} \
