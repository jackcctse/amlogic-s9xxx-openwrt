...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        liblucihttp-lua losetup lsattr lsblk lscpu mkf2fs mount-utils openssl-util parted iptables-nft\
        perl-http-date perlbase-file perlbase-getopt perlbase-time perlbase-unicode perlbase-utf8 \
        pigz ppp ppp-mod-pppoe proto-bonding pv rename resize2fs runc tar tini htop tune2fs tailscale\
